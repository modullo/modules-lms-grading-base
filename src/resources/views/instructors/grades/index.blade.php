    ...
    <div id="app">
        <breadcrumbs 
            :items="[
                ...
                {url: '', title: 'Students Grade', active: true},
            ]">
        </breadcrumbs>
        <b-container>
            <b-row>
                <b-col>
                    <admin-lessons-grades></admin-lessons-grades>
                </b-col>
            </b-row>
        </b-container>
    </div>
...
@section('body_js')
    <script src="{{ asset('vendor/GradingBaseAssets/admin-view/components/AdminLessonsGrades.js') }}"></script>
